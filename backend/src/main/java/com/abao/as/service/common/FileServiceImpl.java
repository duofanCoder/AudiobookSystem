...
import com.abao.as.repository.common.FileRepository;
...
public class FileServiceImpl implements FileService {
    ...
    public List<FileDto> upload(MultipartFile[] files) {
        ...
        for (MultipartFile file : files) {
            ...
            try {
                com.abao.as.model.common.File bizFile = getImageInfo(file);
    ...
    private com.abao.as.model.common.File getImageInfo(MultipartFile file) throws IOException {
        ...
        //获取默认图像的高度，宽度
        return new com.abao.as.model.common.File()
    ...
    @Override
    public com.abao.as.model.common.File saveFile(MultipartFile file) {
        com.abao.as.model.common.File bizFile = null;
        try {
            if (file.isEmpty()) {
    ...
    private com.abao.as.model.common.File getFileInfo(MultipartFile file) throws IOException {
        //字节流转图片对象
        String suffix = "." + FileUtil.getSuffix(file.getOriginalFilename());
        ...
        return new com.abao.as.model.common.File()
                ...
                .setSize(file.getSize())
                .setSuffix(suffix)
                .setFilePath( "novel/" + fileName + suffix)
