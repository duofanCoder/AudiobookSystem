...
public class ApplicationConfiguration {
    ...
    public Docket swaggerSApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("System")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.abao.as.controller.v1.api"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("System - REST APIs")
                .description("Audiobook System.").termsOfServiceUrl("")
                .contact(new Contact("多凡", "https://duofan.top/", "2441051071@qq.com"))
